...
| `make seat-journey` | Opt-in Target C seat ladder. Prints merge, convert, seat, and import against fixture stubs. Does not train, convert, or promote. Not in smoke or `gate-90`. |
