...
Snapshot of **what is on `main` through PR #179**
...
| tip honesty through #179 | Tip framing stopped at PR #177 after the print-only purpose-build host picker had landed. | GATE-90 and Cell One name tip through PR #179 (`4772e0f001a9422cefa8e6f2a9378836285068c7`), including tip honesty through PR #177 (PR #178, `215933daa8a0c6789ab449ffd80fa9c786e5905e`) and print-only `make purpose-build-pick` (operator section 17). Docs and locks only. READY no. |
