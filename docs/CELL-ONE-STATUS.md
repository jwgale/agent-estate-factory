...
Snapshot of **what is on `main` through PR #187** (`4df2c56d5ab622ea3843ade97e4a0dec9ea5b01a`).
...
The recorded 5090-class Target C live uniqueness PASS is [Target C live uniqueness (5090-class)](LIVE-PROBES.md) (PR #153, `16cea97d56079a60c033c7a10468ddd7092a2ef1`).
Tip honesty through PR #153 is PR #154 (`4f0a2096dcf768ce988f320706ad7319aa7d489e`).
The print-only uniqueness prove checklist is PR #155 (`cbecb0b554a655a5276e0c75b8fdc59d55c77f76`).
Tip honesty through PR #155 is PR #156 (`87072dbf79b302dc2dce42e49937abbbdd6ac689`).
Standing next (estate) on `make uniqueness-prove-checklist` is PR #157 (`6a43ff12a91295739c5a9c8a8f1dc9cc9c084466`).
Tip honesty for that coda is PR #158 (`11ff8a84f2ffe37b663ed293d9b00ff415f69c8e`).
Print-only `make uniqueness-full-lora` is PR #159 (`9bc8db52ee157bc7c50261362c7790d4248ed4b4`).
Print-only `make axolotl-qlora-journey` and `make uniqueness-axolotl` are PR #160 (`1b06ea067f7cec44649fbc3aba6650dc0ad6b0f9`).
Print-only `make unsloth-qlora-journey` and `make uniqueness-unsloth` are PR #162 (`e60d201af8c852e7b54eda7e2e37deb52428e38a`), operator section 12.
Print-only `make axolotl-lora-journey` and `make uniqueness-axolotl-lora` are PR #161 (`0cc8b9e5bf2423d90f54f222a182804b3b337d94`), operator section 13.
Tip honesty through PR #161 is PR #163 (`7a08b76b7f9f95922758c260351b310de66a74e4`).
Axolotl doctor and status train honesty is PR #164 (`bd5a515901852b95d1415bb55eb557e5ed424d8d`). `estate doctor` and `estate status` print `axolotl-lora` and `axolotl-qlora` as `status=integration` and `live=false`.
Print-only `make unsloth-lora-journey` and `make uniqueness-unsloth-lora` are PR #165 (`7a1b3d54d37b38977c5570679d7f3922b9404d4a`), operator section 14.
Tip honesty through PR #165 is PR #166 (`f5be4c896babc8be60e6bbcad46196acfa533fdc`).
Unsloth doctor and status train honesty is PR #167 (`c244e721d7275651ecfa1c8f4578ba008a668aa9`). `estate doctor` and `estate status` print `unsloth-qlora` and `unsloth-lora` as `status=optional` and `live=false` once each. Axolotl stays `status=integration`. Unsloth is not relabeled integration.
Tip honesty through PR #167 is PR #168 (`45f8808dbb9d8c837619ae5015aa26777f46f0a6`).
Print-only `make purpose-build-checklist` is PR #169 (`aa374875f221be908ff473c8096eeea1c0f32846`), operator section 15. It prints seven ordered steps (choose a train card, `SKIP live train`, merge and export print, gguf-convert print, local-seat print, `import-trained` with `trained_shape` `gguf` and `auto_apply=false`, Standing next (estate)) and does not run them. The re-prove card stays `make uniqueness-prove-checklist`.
Tip honesty through PR #169 is PR #170 (`54a049cc9983ffe1d8b3f25827367d4058f47b68`).
`estate help enrich` and `estate help train` name `make purpose-build-checklist` as the print-only operator path for purpose-building an SLM on demand (operator section 15, PR #171, `651f31a4dd3a84dad270d40dbdd3892081b9380e`). The index help, the README opt-in one-liner, and the Makefile comment name that same path.
Tip honesty through PR #171 is PR #172 (`0839d6372160ba46763e50cc47e336b2daf6345f`).
`estate doctor` and `estate status` print `mlx-lm-lora` as `status=optional` and `live=false` once each (PR #173, `1002abcdaf648277e15750a44a16e53b324a251d`). Axolotl stays `status=integration` and `live=false`. Unsloth stays `status=optional` and `live=false`. The catalog already says optional. This slice does not relabel that card integration.
Tip honesty through PR #173 is PR #174 (`2234e95f6aebd219e5e6733f108400782e6a623b`).
Print-only `make mlx-lm-lora-journey` and `make uniqueness-mlx` are PR #175 (`7cc330801c3b7f87f2b9ecd23a21d823d5b87b12`), operator section 16.
Tip honesty through PR #175 is PR #176 (`b31461e3cbe910dbbcd146a58d3335f37adced39`).
`estate help enrich` and `estate help train` name `make mlx-lm-lora-journey` as the print-only Apple Silicon mlx-lm LoRA journey (operator section 16, PR #177, `3fb3e8d48b1d6fcc92a88d2b2038faff98dae0be`) and `make uniqueness-mlx` as the print-only chain of that journey. The index help, the README opt-in one-liner, and the Makefile comments name that same path.
Tip honesty through PR #177 is PR #178 (`215933daa8a0c6789ab449ffd80fa9c786e5905e`).
Print-only `make purpose-build-pick` is PR #179 (`4772e0f001a9422cefa8e6f2a9378836285068c7`), operator section 17. It prints a host and stack table and does not run the named targets.
Tip honesty through PR #179 is PR #180 (`3fae4d53821966acfa69f688ba8de5405b20513e`).
Print-only `make purpose-build-journey` is PR #181 (`c4a6d255a08146613c9c6cba262959d913f5cac0`), operator section 18. It runs `make purpose-build-pick`, then `make purpose-build-checklist`, and does not inline their bodies.
Tip honesty through PR #181 is PR #182 (`7e098a9b0ec360c952b2b1c2273654e44de6776c`). Print-only `make deepseek-r1-distill-journey` and `make uniqueness-deepseek` are PR #183 (`b93e89f1983027a13008cc4be23f44756af0f22e`), operator section 19, plus the LoRA twin `make deepseek-r1-distill-lora-journey` and `make uniqueness-deepseek-lora`. They do not train. Tip honesty through PR #183 is PR #184 (`87482dbc847c364056df778fa6170a22efad4c8b`). Print-only `make glm4-chat-journey` and `make uniqueness-glm` are PR #185 (`54c28b968879fccbc157dd7d9fdf7c10e9d0d58c`), operator section 20, plus the LoRA twin `make glm4-chat-lora-journey` and `make uniqueness-glm-lora`. They do not train. Tip honesty through PR #185 is PR #186 (`ef839830b9de29caa963cece687e35c83dd77af6`). `make purpose-build-checklist` step 1 names the DeepSeek-R1-Distill and GLM-4 Chat print journeys (operator section 15, PR #187, `4df2c56d5ab622ea3843ade97e4a0dec9ea5b01a`) and does not run them.
Those journeys stay print-only. This page does not invent a live PASS. The recorded 5090-class Target C live uniqueness PASS stays the only live uniqueness prove.
...
-> [`operator-enrich-journeys.md`](operator-enrich-journeys.md) sections 8–20
...
Opt-in journeys stay off `make smoke`, `make gate-90`, and GitHub Actions. `make qlora-journey` prints Target C and `SKIP live train` (section 8 of [`operator-enrich-journeys.md`](operator-enrich-journeys.md)). `make lora-journey` prints Target A and `SKIP live train` (section 9). `make seat-journey` prints `SKIP live train`, `SKIP live convert`, and `SKIP live seat` (section 10). `make lf-beachhead-prepare` (PR #142, `d2dcdb97c2c960e8b93715391d77075055a8b0ce`) prepares every row of that table on a throwaway copy of `examples/estate.yaml`, checks the row knobs, and prints `SKIP live train`. It does not train, merge, convert, seat, or promote. Phi-3-small stays QLoRA-only and is not a row. `CELL_SEAT_LIVE=1` does not start a convert or an `ollama create`. [`GATE-90.md`](GATE-90.md) Remaining names `make lf-beachhead-prepare` via PR #143 (`3acdec3983ea581976649ba4b7cc41a4cd22d31d`). `make uniqueness-ladder` runs the Target C print path in order: `make qlora-journey`, then `make seat-journey`. It does not train. It is not in smoke or Actions. It is not a live train. It does not run `make lf-beachhead-prepare`. It does not run `make train-next`. `make train-next` prepares the same Target C card and prints the `NEXT.md` `llamafactory-cli train` line. It prints `SKIP live train`. `CELL_TRAIN_LIVE=1` stays print-only. `make uniqueness-full` runs `make qlora-journey`, then `make train-next`, then `make seat-journey`. It does not train, merge, convert, seat, or promote. It is not in smoke or Actions. It is not a live train. `make uniqueness-ladder` stays `make qlora-journey`, then `make seat-journey`, and does not run `make train-next`. `make uniqueness-prove-checklist` (PR #155, `cbecb0b554a655a5276e0c75b8fdc59d55c77f76`) prints the ordered operator steps for the recorded PASS [Target C live uniqueness (5090-class)](LIVE-PROBES.md). It does not train, convert, shell out to ollama, or promote. It does not invent a new live PASS. `CELL_TRAIN_LIVE=1` and `CELL_SEAT_LIVE=1` stay print-only. It is not in `make smoke`, `make gate-90`, or GitHub Actions. It is not native MLX. It is not a live train. After step 8 (`import-trained`, `trained_shape` `gguf`, `auto_apply=false`) the same command prints Standing next (estate) (PR #157, `6a43ff12a91295739c5a9c8a8f1dc9cc9c084466`). The proposal stays `auto_apply=false`. The factory does not apply the estate without an explicit operator `--require-plan` path. The curator path is `packs accept --curator jason`. No promote and no auto-promote. `examples/estate.yaml` stays unchanged unless the operator deliberately applies a plan. The coda names `apply-proposal`, `plan`, `apply --require-plan`, and `reconcile` and does not execute them. The recorded PASS stays on that LIVE-PROBES section. The re-prove card is `make uniqueness-prove-checklist`. `make purpose-build-checklist` prints the purpose-build on demand loop (operator section 15): choose a train card (`make lf-beachhead-prepare`, or `make qlora-journey` / `make lora-journey` / the Axolotl and Unsloth journeys, plus `make deepseek-r1-distill-journey` / `make uniqueness-deepseek` and the LoRA twins, and `make glm4-chat-journey` / `make uniqueness-glm` and the LoRA twins), a train-next style `SKIP live train`, merge-adapt and export print honesty, `gguf-convert`, the local-seat print, `import-trained` (`trained_shape` `gguf`, `auto_apply=false`), then Standing next (estate). The proposal stays `auto_apply=false`. No promote and no auto-promote. The coda names `apply-proposal`, `plan`, `apply --require-plan`, and `reconcile` and does not execute them. It does not run those print journeys. It does not train, convert, shell out to ollama, promote, or apply the estate. It does not invent a live PASS. The recorded 5090-class Target C live uniqueness PASS stays the only live uniqueness prove. The re-prove card stays `make uniqueness-prove-checklist`. It is not in `make smoke`, `make gate-90`, or GitHub Actions. It is not native MLX. This checklist is PR #169 (`aa374875f221be908ff473c8096eeea1c0f32846`). `make purpose-build-journey` is the print-only purpose-build on-demand entry (operator section 18). It runs `make purpose-build-pick`, then `make purpose-build-checklist`. It does not train, fuse, convert, shell out to ollama, promote, or apply the estate. It does not invent a live PASS. `READY_FOR_LIVE_TEST`: no.

`make axolotl-lora-journey` prepares `axolotl-lora` on a throwaway copy of `examples/estate.yaml` (seat tag `llama3`, train base `Qwen/Qwen2.5-0.5B-Instruct`) and checks `axolotl.yml` against Axolotl `examples/llama-3/lora-1b.yml` (`adapter: lora`, `load_in_8bit: false`, `load_in_4bit: false`, `sequence_len` 2048, `lora_r` 16). A seat tag with no train base is `refuse:train-base`. A missing adapter is `refuse:adapter`. A missing merged directory or GGUF is `refuse:seat`. Before the good stub, a Qwen-shaped merged directory is `refuse:tokenizer`. `merge-adapt` prints `axolotl merge-lora` without `--dequant`. `import-trained` records `trained_shape` `gguf` and the proposal stays `auto_apply=false`. `make uniqueness-axolotl-lora` runs the prepare-assert phase, then the seat-print phase. Both stay print-only. `CELL_TRAIN_LIVE=1` and `CELL_SEAT_LIVE=1` stay print-only. They do not run Axolotl, convert, shell out to ollama, or promote. This path does not invent a live PASS. They are not in `make smoke`, `make gate-90`, or GitHub Actions. `make uniqueness-axolotl` stays the 4-bit card. `READY_FOR_LIVE_TEST`: no.

`make uniqueness-full-lora` (PR #159, `9bc8db52ee157bc7c50261362c7790d4248ed4b4`) runs `make lora-journey`, then `make train-next-lora`, then `make seat-journey-lora`. It does not train, merge, convert, seat, or promote. It does not run `make lf-beachhead-prepare`. `make uniqueness-full` stays the QLoRA chain.

`make axolotl-qlora-journey` prepares `axolotl-qlora` on a throwaway copy of `examples/estate.yaml` (seat tag `llama3`, train base `Qwen/Qwen2.5-0.5B-Instruct`) and checks `axolotl.yml` against Axolotl `examples/llama-3/qlora.yml` (`adapter: qlora`, `load_in_4bit: true`, `sequence_len` 4096, `lora_r` 32). `merge-adapt` prints `axolotl merge-lora`, including `--dequant`. `make uniqueness-axolotl` runs the prepare-assert phase, then the seat-print phase. Both stay print-only. They do not run Axolotl, convert, shell out to ollama, or promote. This path does not invent a live PASS. They are not in `make smoke`, `make gate-90`, or GitHub Actions. Walk: section 11 of [`operator-enrich-journeys.md`](operator-enrich-journeys.md). PR #160 (`1b06ea067f7cec44649fbc3aba6650dc0ad6b0f9`). `READY_FOR_LIVE_TEST`: no.

`make unsloth-qlora-journey` prepares `unsloth-qlora` on a throwaway copy of `examples/estate.yaml` (seat tag `llama3`, train base `Qwen/Qwen2.5-0.5B-Instruct`) and checks the `UNSLOTH.md` handoff. The card stays an operator-owned handoff. It does not write a script, a recipe, or `dataset.jsonl`. `merge-adapt` prints `save_pretrained_merged` with `save_method` `merged_16bit`. `make uniqueness-unsloth` runs the prepare-assert phase, then the seat-print phase. Both stay print-only. They do not call Unsloth, convert, shell out to ollama, or promote. This path does not invent a live PASS. They are not in `make smoke`, `make gate-90`, or GitHub Actions. Walk: section 12 of [`operator-enrich-journeys.md`](operator-enrich-journeys.md). PR #162 (`e60d201af8c852e7b54eda7e2e37deb52428e38a`). `READY_FOR_LIVE_TEST`: no.

The Axolotl LoRA journey above is operator section 13 (PR #161, `0cc8b9e5bf2423d90f54f222a182804b3b337d94`). `READY_FOR_LIVE_TEST`: no.

`make unsloth-lora-journey` prepares the optional NEXT card `unsloth-lora` (status `optional`), the non-quant twin of `unsloth-qlora`, on that same throwaway copy. It writes `UNSLOTH.md` and does not write a script, a recipe, or `load_in_4bit`. `merge-adapt` prints `save_pretrained_merged` (`merged_16bit` and `save_method` `lora`). `import-trained` records `trained_shape` `gguf` and the proposal stays `auto_apply=false`. `make uniqueness-unsloth-lora` runs the prepare-assert phase, then the seat-print phase. It does not run `make unsloth-qlora-journey` or `make uniqueness-unsloth`. Both stay print-only. They do not call Unsloth, convert, shell out to ollama, or promote. This path does not invent a live PASS. They are not in `make smoke`, `make gate-90`, or GitHub Actions. Walk: section 14 of [`operator-enrich-journeys.md`](operator-enrich-journeys.md). PR #165 (`7a1b3d54d37b38977c5570679d7f3922b9404d4a`). `READY_FOR_LIVE_TEST`: no.

`estate doctor` and `estate status` print `unsloth-qlora` and `unsloth-lora` as `status=optional` and `live=false` once each (PR #167, `c244e721d7275651ecfa1c8f4578ba008a668aa9`). Axolotl stays `status=integration`. Unsloth is not relabeled integration. They report prepare records and do not claim a train, a promote, a live PASS, or a prepare count. The catalog already says optional. Operator section 12 and section 14 stay print-only. This path does not invent a live PASS. `READY_FOR_LIVE_TEST`: no.

`estate doctor` and `estate status` print `mlx-lm-lora` as `status=optional` and `live=false` once each. Axolotl stays `status=integration` and `live=false`. Unsloth stays `status=optional` and `live=false`. The catalog already says optional. This slice does not relabel that card integration. The card writes `MLX.md` and does not call mlx-lm. It is included under `--job train` only when `host_class_affinity` is `apple-silicon`. Another affinity is `refuse:host` when that driver is named, and `--all-drivers` omits it. They report prepare records and do not claim a train, a promote, a live PASS, or a prepare count. This path does not invent a live PASS. `READY_FOR_LIVE_TEST`: no.

`make mlx-lm-lora-journey` prepares the optional NEXT card `mlx-lm-lora` (status `optional`) on a throwaway copy of `examples/estate.yaml` (seat tag `llama3`, train base `Qwen/Qwen2.5-0.5B-Instruct`). The throwaway pack sets `host_class_affinity` to `apple-silicon`. The stock overnight pack stays `any` and is `refuse:host`. The card writes `MLX.md` and does not call mlx-lm. `merge-adapt` prints `mlx_lm.fuse` with `--adapter-path`, `--save-path` `fused_model`, and `--export-gguf` (`ggml-model-f16.gguf`). `gguf-convert` stays `refuse:seat`. A fused MLX directory is `refuse:adapter` and `refuse:seat`. `local-seat --adapter` stays `refuse:adapter`. `import-trained` records `trained_shape` `gguf` and the proposal stays `auto_apply=false`. `make uniqueness-mlx` runs the prepare-assert phase, then the seat-print phase. It does not run `make unsloth-qlora-journey` or `make uniqueness-unsloth`. Both stay print-only. They do not call mlx-lm, fuse, convert, shell out to ollama, or promote. This path does not invent a live PASS. They are not in `make smoke`, `make gate-90`, or GitHub Actions. Not native MLX. Walk: section 16 of [`operator-enrich-journeys.md`](operator-enrich-journeys.md). `READY_FOR_LIVE_TEST`: no.

`gguf-convert` returns `refuse:tokenizer` when `extra_special_tokens` is a JSON list or JSON null, and when a Qwen-family export is missing `vocab.json` or `merges.txt`. The refuse names the restore: copy tokenizer files from the HF cache snapshot for the train base, or the equivalent base checkout, into the export directory. HF hub snapshots are often symlinks into the HF cache. Copy with dereference (`cp -aL` or `cp --dereference`, or the equivalent) so the files in the export directory are real files, not symlinks. A plain `cp -a` leaves `tokenizer_config.json` as a symlink. Enrich does not follow a symlinked `tokenizer_config.json`. Keep the export `tokenizer_config.json` as `tokenizer_config.json.bak`, then re-run `estate enrich gguf-convert`. The command does not copy those files and does not download them. The recorded 5090 case stays on [`local-seat.md`](local-seat.md). That dereference sentence is PR #149 (`a272d39b731996524883e1124478dddc3f76935c`). `refuse:tokenizer` stays before the restore.

Print journeys resolve `estate` fail-closed when `cargo` is off PATH (PR #148, `ac8348a2d5cd0979ecf285c51153d12b3233442c`). An executable `ESTATE_BIN` is first, then `target/release/estate`, then `target/debug/estate`, then `cargo run -q -p estate-control --` when `cargo` is on PATH. A set `ESTATE_BIN` that is not executable does not fall through. `make uniqueness-full` and `make uniqueness-ladder` still only call `make`. Those print journeys stay off `make smoke`, `make gate-90`, and GitHub Actions.

`estate enrich local-seat` on a GGUF is print-only (PR #150, `663c806ae72826cff664ea32e8a370e059ba83d4`). It prints the Modelfile and does not write `$PREPARED/Modelfile`. Write that file from the printed contents before `ollama create`. The command does not shell out to ollama and does not promote. Help and the seat docs scope that write line to GGUF print-only seats (PR #151, `ecbe8a1c9e5ebe80d581f2c82a2c194cf165aa67`). When `modelfile_on_disk=true`, the report uses the on-disk Modelfile when FROM already names the artifact. Do not write `$PREPARED/Modelfile` again. That covers a merged `--weights` export whose LLaMA-Factory Modelfile is already on disk, and a GGUF whose FROM already names that file.

Pages: [`TRAIN-ENRICH.md`](TRAIN-ENRICH.md). Walks: sections 8–20 of [`operator-enrich-journeys.md`](operator-enrich-journeys.md). Seat: [`local-seat.md`](local-seat.md). Live handoff: [`LIVE-PROBES.md`](LIVE-PROBES.md). `examples/estate.yaml` stays hash-locked. Prepare against that file is `refuse:base-model`.

Prepare still writes files and does not apply the estate by itself. `--all-drivers` writes every card the job allows, or writes none if one card refuses. The enrich default skips `llamafactory-lora`, `llamafactory-qlora`, `axolotl-lora`, `axolotl-qlora`, `unsloth-qlora`, `unsloth-lora`, and `mlx-lm-lora`. `--job train` includes them. `mlx-lm-lora` is included only when `host_class_affinity` is `apple-silicon`. Another affinity is `refuse:host` when that driver is named, and `--all-drivers` omits it. The card writes `MLX.md` and does not call mlx-lm. Each directory has `prepare.json`, `PREPARE.md`, and `NEXT.md`. `estate enrich list` refuses when `.cell/enrich` is missing. After you create the local model outside the factory, `estate enrich import-prepared` checks the tag and the file and writes a `local_slm` binding proposal. `estate enrich apply-proposal` stages that binding. `estate plan` and `estate apply --require-plan` write the source estate. Apply without `--require-plan` leaves the source unchanged. `make enrich-prepare` checks that loop on a throwaway copy and expects `FROM llama3` when the copy sets `params.model`. `estate enrich from-pack` is the same prepare for an accepted pack. `make enrich-live-prove` is opt-in: it runs `ollama create` when the seat is up, checks `ollama show`, and removes the tag. Promote stays off. A sacred line, a hardware SKU, a missing pack, the wrong curator, or a frontier tag with no frontier binding stops before those files exist. `axolotl-lora` writes the bf16 YAML. `axolotl-qlora` writes the 4-bit YAML. `NEXT.md` names `axolotl train`. `make train-prepare` prints `SKIP live train`. Default `dataset.jsonl` stays a scaffold unless `--from-feed` copies rows already under the cell state directory. A missing file is `refuse:dataset`. `estate status` and `estate doctor` print each `prepare.json` (pack, driver, job, seat tag, train base, `trained_shape` when import-trained recorded it, and the out path) and stay silent when that directory is missing. A broken `prepare.json` or a symlink refuses. They do not invent a prepare count and they do not claim the factory trained. Catalog lines name `mlx-lm-lora`, `unsloth-qlora`, and `unsloth-lora` as optional.

## Day 0–90 factory (merged in PR #1–#82)

Day 0-90 factory is merged. The beachhead matrix in the uniqueness section above is PR #140. The print-only prepare walk of that matrix is PR #142. GATE-90 Remaining names `make lf-beachhead-prepare` via PR #143. Tip through PR #187 (`4df2c56d5ab622ea3843ade97e4a0dec9ea5b01a`) also names the `ESTATE_BIN` fallback (PR #148), the tokenizer restore dereference (PR #149), the print-only local-seat Modelfile (PR #150), the GGUF write-Modelfile line (PR #151), docs-and-locks tip honesty for that line (PR #152, `b4f9c321f2c21c4cac1eb24b8c5b002035318ce4`), the recorded 5090-class Target C live uniqueness PASS (PR #153, `16cea97d56079a60c033c7a10468ddd7092a2ef1`), tip honesty through PR #153 (PR #154, `4f0a2096dcf768ce988f320706ad7319aa7d489e`), the print-only uniqueness prove checklist (PR #155, `cbecb0b554a655a5276e0c75b8fdc59d55c77f76`), tip honesty through PR #155 (PR #156, `87072dbf79b302dc2dce42e49937abbbdd6ac689`), the Standing next (estate) coda on `make uniqueness-prove-checklist` (PR #157, `6a43ff12a91295739c5a9c8a8f1dc9cc9c084466`), tip honesty for that coda (PR #158, `11ff8a84f2ffe37b663ed293d9b00ff415f69c8e`), print-only `make uniqueness-full-lora` (PR #159, `9bc8db52ee157bc7c50261362c7790d4248ed4b4`), print-only `make axolotl-qlora-journey` and `make uniqueness-axolotl` (PR #160, `1b06ea067f7cec44649fbc3aba6650dc0ad6b0f9`), print-only `make unsloth-qlora-journey` and `make uniqueness-unsloth` (operator section 12, PR #162, `e60d201af8c852e7b54eda7e2e37deb52428e38a`), print-only `make axolotl-lora-journey` and `make uniqueness-axolotl-lora` (operator section 13, PR #161, `0cc8b9e5bf2423d90f54f222a182804b3b337d94`), tip honesty through PR #161 is PR #163 (`7a08b76b7f9f95922758c260351b310de66a74e4`), Axolotl doctor and status train honesty is PR #164 (`bd5a515901852b95d1415bb55eb557e5ed424d8d`), print-only `make unsloth-lora-journey` and `make uniqueness-unsloth-lora` (operator section 14, PR #165, `7a1b3d54d37b38977c5570679d7f3922b9404d4a`), tip honesty through PR #165 is PR #166 (`f5be4c896babc8be60e6bbcad46196acfa533fdc`), Unsloth doctor and status train honesty is PR #167 (`c244e721d7275651ecfa1c8f4578ba008a668aa9`) (`unsloth-qlora` and `unsloth-lora` stay `status=optional` and `live=false` once each; Axolotl stays `status=integration`; Unsloth is not relabeled integration), tip honesty through PR #167 is PR #168 (`45f8808dbb9d8c837619ae5015aa26777f46f0a6`), and print-only `make purpose-build-checklist` (operator section 15, PR #169, `aa374875f221be908ff473c8096eeea1c0f32846`) prints seven ordered steps (choose a train card, `SKIP live train`, merge and export print, gguf-convert print, local-seat print, `import-trained` with `trained_shape` `gguf` and `auto_apply=false`, Standing next (estate)) and does not run them. The re-prove card stays `make uniqueness-prove-checklist`. Tip honesty through PR #169 is PR #170 (`54a049cc9983ffe1d8b3f25827367d4058f47b68`). `estate help enrich` and `estate help train` name `make purpose-build-checklist` as the print-only operator path for purpose-building an SLM on demand (operator section 15, PR #171, `651f31a4dd3a84dad270d40dbdd3892081b9380e`). The index help, the README opt-in one-liner, and the Makefile comment name that same path. Tip honesty through PR #171 is PR #172 (`0839d6372160ba46763e50cc47e336b2daf6345f`). `estate doctor` and `estate status` print `mlx-lm-lora` as `status=optional` and `live=false` once each (PR #173, `1002abcdaf648277e15750a44a16e53b324a251d`). Axolotl stays `status=integration` and `live=false`. Unsloth stays `status=optional` and `live=false`. The catalog already says optional. This slice does not relabel that card integration. Tip honesty through PR #173 is PR #174 (`2234e95f6aebd219e5e6733f108400782e6a623b`). Print-only `make mlx-lm-lora-journey` and `make uniqueness-mlx` (operator section 16, PR #175, `7cc330801c3b7f87f2b9ecd23a21d823d5b87b12`). Tip honesty through PR #175 is PR #176 (`b31461e3cbe910dbbcd146a58d3335f37adced39`). `estate help enrich` and `estate help train` name `make mlx-lm-lora-journey` as the print-only Apple Silicon mlx-lm LoRA journey (operator section 16, PR #177, `3fb3e8d48b1d6fcc92a88d2b2038faff98dae0be`) and `make uniqueness-mlx` as the print-only chain of that journey. The index help, the README opt-in one-liner, and the Makefile comments name that same path. Tip honesty through PR #177 is PR #178 (`215933daa8a0c6789ab449ffd80fa9c786e5905e`). Print-only `make purpose-build-pick` (operator section 17, PR #179, `4772e0f001a9422cefa8e6f2a9378836285068c7`) prints a host and stack table and does not run the named targets. Tip honesty through PR #179 is PR #180 (`3fae4d53821966acfa69f688ba8de5405b20513e`). Print-only `make purpose-build-journey` (operator section 18, PR #181, `c4a6d255a08146613c9c6cba262959d913f5cac0`) runs `make purpose-build-pick`, then `make purpose-build-checklist`, and does not inline their bodies. Tip honesty through PR #181 is PR #182 (`7e098a9b0ec360c952b2b1c2273654e44de6776c`). Print-only `make deepseek-r1-distill-journey` and `make uniqueness-deepseek` (operator section 19, PR #183, `b93e89f1983027a13008cc4be23f44756af0f22e`) plus the LoRA twin `make deepseek-r1-distill-lora-journey` and `make uniqueness-deepseek-lora` print the DeepSeek-R1-Distill chat ladder and do not train. Tip honesty through PR #183 is PR #184 (`87482dbc847c364056df778fa6170a22efad4c8b`). Print-only `make glm4-chat-journey` and `make uniqueness-glm` (operator section 20, PR #185, `54c28b968879fccbc157dd7d9fdf7c10e9d0d58c`) plus the LoRA twin `make glm4-chat-lora-journey` and `make uniqueness-glm-lora` print the GLM-4 Chat ladder and do not train. Tip honesty through PR #185 is PR #186 (`ef839830b9de29caa963cece687e35c83dd77af6`). `make purpose-build-checklist` step 1 names the DeepSeek-R1-Distill and GLM-4 Chat print journeys (operator section 15, PR #187, `4df2c56d5ab622ea3843ade97e4a0dec9ea5b01a`) and does not run them. Those journeys stay print-only. This sentence does not invent a live PASS. The recorded 5090-class Target C live uniqueness PASS stays the only live uniqueness prove. Horizon / Research / Sanctum on separate lanes.
...
| train recipe | The durable train recipe is LLaMA-Factory QLoRA. Axolotl stays the second YAML card. Unsloth was a NEXT.md pointer. | `llamafactory-qlora` writes `recipe.yaml`, `export.yaml`, and instruct chat `dataset.jsonl`. `axolotl-lora` stays the YAML card. Neither card runs a trainer. `import-trained` records the adapter on the existing `local_slm` proposal. `make train-prepare` prints `SKIP live train`. READY no. |
| train base | `model_name_or_path` was the Ollama seat tag, so an unedited recipe named `llama3` as if it were trainable weights. | The seat tag stays Modelfile `FROM`. The train base is pack `train_base_model` or `params.train_base_model`: a Hugging Face repo id or a local HF weights directory. `template` follows that train base. A bare seat tag is `refuse:train-base`. `--max-steps` is the gauge path. `quantization_method` stays `bnb`. READY no. |
| axolotl train base | `axolotl.yml` `base_model` was the Ollama seat tag, so `--all-drivers --job train` wrote a runnable yaml that named `llama3` as weights. | `base_model` in `axolotl.yml` is the train base. The seat tag stays in `prepare.json` for Modelfile `FROM` and the adapter join. A missing base, a bare seat tag, or a seat-looking local leaf is `refuse:train-base`. `unsloth-qlora` is an optional Nvidia-only handoff (`UNSLOTH.md`) and does not write a script. READY no. |
| lora prepare | `llamafactory-qlora` always wrote QLoRA (`quantization_bit: 4`, `quantization_method: bnb`, template `qwen3`, rank 16), so the LLaMA-Factory LoRA quickstart needed a hand edit. | `--driver llamafactory-lora` writes 16-bit LoRA: no quantization fields, rank 8, `packing: false`. `Qwen/Qwen3-4B-Instruct-2507` uses template `qwen3_nothink`. QLoRA stays `--driver llamafactory-qlora` and still requires bitsandbytes. The LoRA path does not. `export.yaml` still omits quantization. `refuse:train-base` is unchanged. READY no. |
| phi3 qlora | A Phi-3 or Phi-3.5 train base fell through a generic `phi` substring, so Phi-3-small and Phi-4 could take the wrong template, and the handoff did not name the reproduce target. | `microsoft/Phi-3` mini and medium, and Phi-3.5, infer template `phi`. Phi-3-small infers `phi_small`. Nested path segments match the same way. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name the Phi prepare beside Qwen LoRA/QLoRA. `examples/fixtures/phi3-instruct.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| llama32 qlora | A Llama-3.2 Instruct train base fell through a short `llama-3` substring, so vision and `llama-30b` could take template `llama3`, and the handoff did not name the reproduce target. | `meta-llama/Llama-3.2-1B-Instruct` and `meta-llama/Llama-3.2-3B-Instruct` infer template `llama3`. Llama-3.2 vision infers `mllama`. Nested path segments match the same way. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name the Llama-3.2 prepare beside Phi-3 and Qwen. `examples/fixtures/llama32-instruct.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| llama32 instruct lora | The same Llama-3.2 Instruct ids inferred `llama3` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of the Llama-3.2 Instruct QLoRA prepare. | `llamafactory-lora` writes template `llama3` for `Llama-3.2-1B-Instruct` and `Llama-3.2-3B-Instruct`, including nested path segments and HF cache directories. Vision stays `mllama`. A Llama-3.2 base, Llama-3.1 Instruct, and Llama-3.3 Instruct stay `llama3` and do not get the line. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8 and `packing` false, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that Instruct shape. The QLoRA note stays on `llamafactory-qlora`. `examples/fixtures/llama32-instruct-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| gemma2 qlora | A Gemma-2 Instruct train base fell through a short `gemma` substring, so `google/gemma-2-2b-it` took template `gemma`, and the handoff did not name the reproduce target. | `google/gemma-2-2b-it`, `google/gemma-2-9b-it`, and `google/gemma-2-27b-it` infer template `gemma2`. Original Gemma stays `gemma`. Gemma-3 stays off `gemma2`. Nested path segments match the same way. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name the Gemma-2 Instruct prepare beside Phi-3, Llama-3.2, and Qwen. `examples/fixtures/gemma2-instruct.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| mistral qlora | A Mistral Instruct train base matched any name containing `mistral`, so Mistral-Small, Mistral-Nemo, and LLaVA-NeXT-Mistral took template `mistral`, and the handoff did not name the reproduce target. | `mistralai/Mistral-7B-Instruct-v0.2` and `mistralai/Mistral-7B-Instruct-v0.3` infer template `mistral`. A Mistral-7B base uses that same template and does not get the reproduce line. Mistral-Small infers `mistral_small`. Mistral-Nemo infers `ministral`. Nested path segments match the same way. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name the Mistral Instruct prepare beside Phi-3, Llama-3.2, Gemma-2, and Qwen. `examples/fixtures/mistral-instruct.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| qwen3 instruct qlora | Qwen3 Instruct-2507 prepared like any other Qwen3 name, so the handoff did not name it beside Phi-3, Llama-3.2, Gemma-2, Mistral, and Qwen2.x, and a thinking or Qwen2.5 id could be read as that same target. | `Qwen/Qwen3-4B-Instruct-2507`, `Qwen/Qwen3-30B-A3B-Instruct-2507`, `Qwen/Qwen3-235B-A22B-Instruct-2507`, and `Qwen/Qwen3-Next-80B-A3B-Instruct` infer template `qwen3_nothink`. Thinking and base ids stay `qwen3`. Qwen2.5 stays `qwen`. Nested path segments and HF cache directories match the same way. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name the Qwen3 Instruct prepare beside Phi-3, Llama-3.2, Gemma-2, Mistral, and Qwen2.x only for that shape. `examples/fixtures/qwen3-instruct.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| qwen3 instruct lora | The same Qwen3 Instruct ids inferred `qwen3_nothink` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of `examples/train_lora/qwen3_lora_sft.yaml`. | `llamafactory-lora` writes template `qwen3_nothink` for those Instruct ids, including nested path segments and HF cache directories. Thinking and base ids stay `qwen3`. Qwen2 and Qwen2.5 stay `qwen`. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that Instruct shape. `examples/fixtures/qwen3-instruct-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| gemma2 instruct lora | The same Gemma-2 Instruct ids inferred `gemma2` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of the Gemma-2 Instruct QLoRA prepare. | `llamafactory-lora` writes template `gemma2` for `google/gemma-2-2b-it`, `google/gemma-2-9b-it`, and `google/gemma-2-27b-it`, including nested path segments and HF cache directories. A Gemma-2 base keeps `gemma2` and does not get the line. Original Gemma stays `gemma`. Gemma-3 stays off `gemma2`. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that Instruct shape. `examples/fixtures/gemma2-instruct-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| mistral instruct lora | The same Mistral-7B Instruct ids inferred `mistral` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of the Mistral Instruct QLoRA prepare. | `llamafactory-lora` writes template `mistral` for `mistralai/Mistral-7B-Instruct-v0.1`, `mistralai/Mistral-7B-Instruct-v0.2`, and `mistralai/Mistral-7B-Instruct-v0.3`, including nested path segments and HF cache directories. A Mistral-7B base keeps `mistral` and does not get the line. Mistral-Small stays `mistral_small`. Mistral-Nemo stays `ministral`. Mixtral keeps `mistral` and does not get the line. LLaVA-NeXT-Mistral stays `llava_next_mistral`. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8 and `packing` false, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that Instruct shape. The QLoRA note stays on `llamafactory-qlora`. `examples/fixtures/mistral-instruct-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| phi3 instruct lora | The same Phi-3 and Phi-3.5 Instruct ids inferred `phi` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of the Phi-3 Instruct QLoRA prepare. | `llamafactory-lora` writes template `phi` for Phi-3 mini, Phi-3 medium, and Phi-3.5, including nested path segments and HF cache directories. Phi-3-small stays `phi_small` and does not get the line. Phi-4 stays `phi4`. Phi-4-mini stays `phi4_mini`. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8 and `packing` false, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that Instruct shape. The QLoRA note stays on `llamafactory-qlora`. `examples/fixtures/phi3-instruct-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| qwen2.5 instruct qlora | Qwen2.5 Instruct prepared with template `qwen`, and the handoff named the Qwen3 Instruct line and left Qwen2.5 off that line. | `Qwen/Qwen2.5-0.5B-Instruct` and the other Qwen2.5 Instruct text ids infer template `qwen`, including nested path segments and HF cache directories. A Qwen2.5 base, a thinking-shaped id, Qwen2, Coder, Math, and VL do not get the line. Qwen3 Instruct stays `qwen3_nothink`. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name the Qwen2.5 Instruct prepare beside Phi-3, Llama-3.2, Gemma-2, Mistral, and Qwen3 Instruct only for that shape. `examples/fixtures/qwen25-instruct.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| qwen2.5 instruct lora | The same Qwen2.5 Instruct ids inferred `qwen` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of the Qwen2.5 Instruct QLoRA prepare. | `llamafactory-lora` writes template `qwen` for those Instruct ids, including nested path segments and HF cache directories. A Qwen2.5 base, a thinking-shaped id, Qwen2, Coder, Math, and VL stay `qwen` and do not get the line. Qwen3 Instruct stays `qwen3_nothink`. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8 and `packing` false, and keeps the seat tag separate from the train base. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that Instruct shape. The QLoRA note stays on `llamafactory-qlora`. `examples/fixtures/qwen25-instruct-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| deepseek r1 distill qlora | A DeepSeek-R1-Distill-Qwen train base fell through the `qwen` substring, so the chat distill took template `qwen`, and the handoff did not name the reproduce target. | `deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B` and the other five official R1-Distill chat ids infer template `deepseekr1`, including nested path segments and HF cache directories. A Qwen or Llama substring in those ids stays `deepseekr1`. DeepSeek-R1, DeepSeek-R1-Zero, and DeepSeek-R1-0528 stay `deepseekr1` and do not get the line. The student bases stay `qwen` or `llama3`. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag `llama3` separate from the Hugging Face train base. An Ollama tag `deepseek-r1:1.5b` is a seat tag. `NEXT.md` and `PREPARE.md` name the prepare beside Phi-3, Llama-3.2, Gemma-2, Mistral, Qwen2.5 Instruct, and Qwen3 Instruct only on the QLoRA card and only for that distill shape. `llamafactory-lora` writes the same template and does not get the line. `examples/fixtures/deepseek-r1-distill.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| glm4 chat qlora | A GLM-4 Chat train base had no `glm4` path, so `zai-org/glm-4-9b-chat` stayed template `default`, and the handoff did not name the reproduce target. | `zai-org/glm-4-9b-chat`, `zai-org/glm-4-9b-chat-1m`, `zai-org/GLM-4-9B-0414`, and `zai-org/GLM-4-32B-0414` infer template `glm4`, including nested path segments and HF cache directories. That is the DEFAULT `template="glm4"` group in `constants.py`. `template.py` registers `glm4`. There is no `glm_4` template. A GLM-4 base stays `glm4` and does not get the line. GLM-Z1 stays `glmz1`. GLM-4.1V stays `glm4v`. GLM-4.5 stays `glm4_moe`. ChatGLM3 stays `chatglm3`. `llamafactory-qlora` still writes `quantization_method: bnb` and `quantization_bit: 4`, and keeps the seat tag `llama3` separate from the Hugging Face train base. An Ollama tag `glm4:9b` is a seat tag. `NEXT.md` and `PREPARE.md` name the prepare beside Phi-3, Llama-3.2, Gemma-2, Mistral, Qwen2.5 Instruct, Qwen3 Instruct, and DeepSeek-R1-Distill chat only on the QLoRA card and only for that chat shape. `llamafactory-lora` writes the same template, rank 8, and `packing` false, and does not get the line. `examples/fixtures/glm4-chat.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| glm4 chat lora | The same GLM-4 Chat ids inferred `glm4` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of the GLM-4 Chat QLoRA prepare. | `llamafactory-lora` writes template `glm4` for `zai-org/glm-4-9b-chat`, `zai-org/glm-4-9b-chat-1m`, `zai-org/GLM-4-9B-0414`, and `zai-org/GLM-4-32B-0414`, including nested path segments and HF cache directories. A GLM-4 base stays `glm4` and does not get the line. GLM-Z1 stays `glmz1`. GLM-4.1V stays `glm4v`. GLM-4.5 stays `glm4_moe`. ChatGLM3 stays `chatglm3`. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8 and `packing` false, and keeps the seat tag `llama3` separate from the Hugging Face train base. An Ollama tag `glm4:9b` is a seat tag. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that chat shape. The QLoRA note stays on `llamafactory-qlora`. `examples/train_lora` does not ship a GLM-4 yaml. `examples/fixtures/glm4-chat-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
| deepseek r1 distill lora | The same DeepSeek-R1-Distill chat ids inferred `deepseekr1` on `llamafactory-lora`, but the handoff did not name that card as the non-quant twin of the DeepSeek-R1-Distill chat QLoRA prepare. | `llamafactory-lora` writes template `deepseekr1` for those six chat ids, including nested path segments and HF cache directories. A Qwen or Llama substring in those ids stays `deepseekr1`. DeepSeek-R1, DeepSeek-R1-Zero, and DeepSeek-R1-0528 stay `deepseekr1` and do not get the line. The student bases stay `qwen` or `llama3`. The recipe omits `quantization_bit` and `quantization_method`, keeps `lora_rank` 8 and `packing` false, and keeps the seat tag `llama3` separate from the Hugging Face train base. An Ollama tag `deepseek-r1:1.5b` is a seat tag. `NEXT.md` and `PREPARE.md` name that reproduce target only on the LoRA card and only for that distill shape. The QLoRA note stays on `llamafactory-qlora`. `examples/train_lora` does not ship a DeepSeek yaml. `examples/fixtures/deepseek-r1-distill-lora.pack.json` is the smoke pack. Prepare does not download weights. READY no. |
...
| qwen qlora seat ladder | `make qlora-journey` and `make lora-journey` stop at `refuse:seat` when the merged export and the GGUF are missing, so the happy-path print lines had no single opt-in check. | `make seat-journey` prepares the Target C card, asserts `refuse:tokenizer` on a 5090-shaped export (list `extra_special_tokens`, Qwen `config.json`, missing `vocab.json` and `merges.txt`), then prints `merge-adapt`, `gguf-convert`, `local-seat`, and `import-trained` against the good fixture stubs. The GGUF stub starts with GGUF magic. `import-trained` records `trained_shape` `gguf`. It does not train, convert, or create a model. READY no. |
...
| estate bin fallback | Print journeys called `cargo run` only, so a built `estate` was unused when `cargo` was off PATH. | PR #148. Executable `ESTATE_BIN`, then `target/release/estate`, then `target/debug/estate`, then `cargo run -q -p estate-control --` when `cargo` is on PATH. A set `ESTATE_BIN` that is not executable does not fall through. `make uniqueness-full` and `make uniqueness-ladder` still only call `make`. Print-only. Not in smoke, `make gate-90`, or Actions. READY no. |
...
| tip honesty through #153 | Tip framing stopped at PR #151 after the recorded PASS had landed. | PR #154 (`4f0a2096dcf768ce988f320706ad7319aa7d489e`). GATE-90 and Cell One name tip through PR #153, including the docs-and-locks honesty for PR #151 and the recorded PASS. Docs and locks only. Beachhead matrix, prepare walk, and the uniqueness ladder stay. READY no. |
| uniqueness prove checklist | The recorded Target C ladder had no print-only operator checklist. | PR #155 (`cbecb0b554a655a5276e0c75b8fdc59d55c77f76`). `make uniqueness-prove-checklist` prints the ordered steps for the recorded PASS. It does not train, convert, shell out to ollama, or promote. It does not invent a new live PASS. READY no. |
| tip honesty through #155 | Tip framing stopped at PR #153 after the print-only checklist had landed. | PR #156 (`87072dbf79b302dc2dce42e49937abbbdd6ac689`). GATE-90 and Cell One name tip through PR #155, including tip honesty through PR #153 and the print-only uniqueness prove checklist. Docs and locks only. Beachhead matrix, prepare walk, and the uniqueness ladder stay. READY no. |
| standing next estate | After `import-trained` (`trained_shape` `gguf`, `auto_apply=false`) the prove checklist did not name the plan, apply, and reconcile path, so that join was easy to misread as an apply or a promote. | PR #157 (`6a43ff12a91295739c5a9c8a8f1dc9cc9c084466`). `make uniqueness-prove-checklist` prints Standing next (estate). The proposal stays `auto_apply=false`. No promote and no auto-promote. It names `apply-proposal`, `plan`, `apply --require-plan`, and `reconcile` and does not execute them. The recorded PASS stays on LIVE-PROBES. The re-prove card is that same target. READY no. |
| tip honesty through #157 | Tip framing stopped at PR #155 after the Standing next coda had landed. | PR #158 (`11ff8a84f2ffe37b663ed293d9b00ff415f69c8e`). GATE-90 and Cell One name tip through PR #157, including tip honesty through PR #155 and the Standing next coda. Docs and locks only. READY no. |
| uniqueness-full-lora | Target A had prepare, train-next, and seat prints, and no single print chain that ran them in order. | PR #159 (`9bc8db52ee157bc7c50261362c7790d4248ed4b4`). `make uniqueness-full-lora` runs `make lora-journey`, then `make train-next-lora`, then `make seat-journey-lora`. Print-only. It does not train. `make uniqueness-full` stays the QLoRA chain. Not in smoke, `make gate-90`, or Actions. READY no. |
| axolotl qlora journey | The 4-bit Axolotl card had no print-only prepare and seat journey. | PR #160 (`1b06ea067f7cec44649fbc3aba6650dc0ad6b0f9`). `make axolotl-qlora-journey` and `make uniqueness-axolotl` check `examples/llama-3/qlora.yml` and print merge with `--dequant`, convert, seat, and import against fixture stubs. Operator section 11. Print-only. This path does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| unsloth qlora journey | The optional Unsloth QLoRA handoff had no print-only prepare and seat journey. | PR #162 (`e60d201af8c852e7b54eda7e2e37deb52428e38a`). `make unsloth-qlora-journey` and `make uniqueness-unsloth` check the `UNSLOTH.md` handoff and print merge, convert, seat, and import against fixture stubs. Operator section 12. Print-only. This path does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| axolotl lora journey | The bf16 Axolotl LoRA card had no print-only prepare and seat journey. | PR #161 (`0cc8b9e5bf2423d90f54f222a182804b3b337d94`). `make axolotl-lora-journey` and `make uniqueness-axolotl-lora` check `examples/llama-3/lora-1b.yml` and print merge without `--dequant`, convert, seat, and import against fixture stubs. Operator section 13. `make uniqueness-axolotl` stays the 4-bit card. Print-only. This path does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| tip honesty through #161 | Tip framing stopped at PR #157 after the print-only uniqueness journeys had landed. | PR #163 (`7a08b76b7f9f95922758c260351b310de66a74e4`). GATE-90 and Cell One name tip through PR #161, including tip honesty for the Standing next coda, `make uniqueness-full-lora`, the Axolotl and Unsloth QLoRA journeys, and `make axolotl-lora-journey`. Docs and locks only. READY no. |
| axolotl doctor status | `estate doctor` and `estate status` did not lock `axolotl-lora` and `axolotl-qlora` as integration train cards. | PR #164 (`bd5a515901852b95d1415bb55eb557e5ed424d8d`). Both commands print those cards as `status=integration` and `live=false`, report both prepare records, and do not claim a train or a promote. Garbage or promoted `prepare.json` still fails closed. READY no. |
| unsloth lora journey | The optional Unsloth LoRA handoff had no print-only prepare and seat journey. | PR #165 (`7a1b3d54d37b38977c5570679d7f3922b9404d4a`). `make unsloth-lora-journey` and `make uniqueness-unsloth-lora` check the `UNSLOTH.md` handoff and print `save_pretrained_merged` (`merged_16bit` and `save_method` `lora`), convert, seat, and import against fixture stubs. Operator section 14. `make uniqueness-unsloth` stays the QLoRA card. Print-only. This path does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| tip honesty through #165 | Tip framing stopped at PR #161 after the Unsloth LoRA journey and the Axolotl doctor lock had landed. | PR #166 (`f5be4c896babc8be60e6bbcad46196acfa533fdc`). GATE-90 and Cell One name tip through PR #165, including tip honesty through PR #161, Axolotl doctor and status train honesty, and print-only `make unsloth-lora-journey`. Docs and locks only. READY no. |
| unsloth doctor status | `estate doctor` and `estate status` did not lock `unsloth-qlora` and `unsloth-lora` as optional train cards. | PR #167 (`c244e721d7275651ecfa1c8f4578ba008a668aa9`). Both commands print `unsloth-qlora` and `unsloth-lora` once each as `status=optional` and `live=false`. Axolotl stays `status=integration`. Unsloth is not relabeled integration. They report both prepare records and do not claim a train, a promote, a live PASS, or a prepare count. The catalog already says optional. Garbage or promoted `prepare.json` still fails closed. Operator sections 12 and 14 stay print-only. READY no. |
| tip honesty through #167 | Tip framing stopped at PR #165 after the Unsloth doctor lock had landed. | PR #168 (`45f8808dbb9d8c837619ae5015aa26777f46f0a6`). GATE-90 and Cell One name tip through PR #167, including tip honesty through PR #165 and Unsloth doctor and status train honesty. Docs and locks only. READY no. |
| purpose-build checklist | The prepare → train → merge → seat → import loop had a re-prove card and no print-only card for purpose-build on demand. | PR #169 (`aa374875f221be908ff473c8096eeea1c0f32846`). `make purpose-build-checklist` prints seven ordered steps (choose a train card, `SKIP live train`, merge and export print, gguf-convert print, local-seat print, `import-trained` with `trained_shape` `gguf` and `auto_apply=false`, Standing next (estate)) and does not run them. It does not invent a live PASS. The recorded Target C PASS stays the only live uniqueness prove. The re-prove card stays `make uniqueness-prove-checklist`. Operator section 15. Not in smoke, `make gate-90`, or Actions. READY no. |
| tip honesty through #169 | Tip framing stopped at PR #167 after the purpose-build checklist had landed. | PR #170 (`54a049cc9983ffe1d8b3f25827367d4058f47b68`). GATE-90 and Cell One name tip through PR #169, including tip honesty through PR #167 and print-only `make purpose-build-checklist`. Docs and locks only. READY no. |
| help names purpose-build | Help, the README, and the Makefile did not name `make purpose-build-checklist` as the print-only operator path. | PR #171 (`651f31a4dd3a84dad270d40dbdd3892081b9380e`). `estate help enrich`, `estate help train`, the help index, the README opt-in one-liner, and the Makefile comment name that path (operator section 15). Checklist behavior is unchanged. Not in smoke, `make gate-90`, or Actions. READY no. |
| mlx-lm doctor status | `estate doctor` and `estate status` did not lock `mlx-lm-lora` as an optional train card. | Both commands print that card once each as `status=optional` and `live=false`. Axolotl stays `status=integration` and `live=false`. Unsloth stays `status=optional` and `live=false`. The catalog already says optional. This slice does not relabel that card integration. They report the prepare record and do not claim a train, a promote, a live PASS, or a prepare count. Garbage or promoted `prepare.json` still fails closed. The card writes `MLX.md` and does not call mlx-lm. `--job train` includes it only when `host_class_affinity` is `apple-silicon`. READY no. |
| mlx-lm lora journey | The optional Apple Silicon LoRA handoff had no print-only prepare and seat journey. | PR #175 (`7cc330801c3b7f87f2b9ecd23a21d823d5b87b12`). `make mlx-lm-lora-journey` and `make uniqueness-mlx` check the `MLX.md` handoff and print `mlx_lm.fuse` (`--export-gguf`, `ggml-model-f16.gguf`), seat, and import against fixture stubs. `gguf-convert` stays `refuse:seat`. A fused MLX directory refuses. Operator section 16. Print-only. This path does not invent a live PASS. Not native MLX. Not in smoke, `make gate-90`, or Actions. READY no. |
| tip honesty through #173 | Tip framing stopped at PR #171 after the mlx-lm doctor lock had landed. | GATE-90 and Cell One name tip through PR #173 (`1002abcdaf648277e15750a44a16e53b324a251d`), including tip honesty through PR #171 (PR #172, `0839d6372160ba46763e50cc47e336b2daf6345f`) and mlx-lm doctor and status (`mlx-lm-lora` stays `status=optional` and `live=false` once; Axolotl stays `status=integration` and `live=false`; Unsloth stays `status=optional` and `live=false`). Docs and locks only. READY no. |
| tip honesty through #175 | Tip framing stopped at PR #173 after the print-only mlx-lm LoRA journey had landed. | PR #176 (`b31461e3cbe910dbbcd146a58d3335f37adced39`). GATE-90 and Cell One name tip through PR #175 (`7cc330801c3b7f87f2b9ecd23a21d823d5b87b12`), including tip honesty through PR #173 (PR #174, `2234e95f6aebd219e5e6733f108400782e6a623b`) and print-only `make mlx-lm-lora-journey` and `make uniqueness-mlx` (operator section 16). Docs and locks only. READY no. |
| help names mlx journey | Help, the README, and the Makefile did not name `make mlx-lm-lora-journey` and `make uniqueness-mlx` as the print-only Apple Silicon path. | PR #177 (`3fb3e8d48b1d6fcc92a88d2b2038faff98dae0be`). `estate help enrich`, `estate help train`, the help index, the README opt-in one-liner, and the Makefile comments name that path (operator section 16). Journey behavior is unchanged. Not in smoke, `make gate-90`, or Actions. READY no. |
| tip honesty through #177 | Tip framing stopped at PR #175 after help named the mlx-lm LoRA journey. | PR #178 (`215933daa8a0c6789ab449ffd80fa9c786e5905e`). GATE-90 and Cell One name tip through PR #177 (`3fb3e8d48b1d6fcc92a88d2b2038faff98dae0be`), including tip honesty through PR #175 (PR #176, `b31461e3cbe910dbbcd146a58d3335f37adced39`) and help that names `make mlx-lm-lora-journey` and `make uniqueness-mlx` (operator section 16, PR #177). Docs and locks only. READY no. |
| purpose-build pick | The purpose-build path had an ordered checklist and no print-only host and stack picker. | PR #179 (`4772e0f001a9422cefa8e6f2a9378836285068c7`). `make purpose-build-pick` prints which existing journey to take for which host (operator section 17) and does not run those targets. It does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| tip honesty through #179 | Tip framing stopped at PR #177 after the print-only purpose-build host picker had landed. | PR #180 (`3fae4d53821966acfa69f688ba8de5405b20513e`). GATE-90 and Cell One name tip through PR #179 (`4772e0f001a9422cefa8e6f2a9378836285068c7`), including tip honesty through PR #177 (PR #178, `215933daa8a0c6789ab449ffd80fa9c786e5905e`) and print-only `make purpose-build-pick` (operator section 17). Docs and locks only. READY no. |
| purpose-build journey | The purpose-build path had a picker and a checklist and no print-only entry that runs the pick, then the checklist. | PR #181 (`c4a6d255a08146613c9c6cba262959d913f5cac0`). `make purpose-build-journey` runs `make purpose-build-pick`, then `make purpose-build-checklist` (operator section 18) and does not inline their bodies. It does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| deepseek r1 distill journey | The DeepSeek-R1-Distill chat prepare rows had no print-only prepare and seat journey. | PR #183 (`b93e89f1983027a13008cc4be23f44756af0f22e`). `make deepseek-r1-distill-journey` and `make uniqueness-deepseek` check `llamafactory-qlora` on `examples/fixtures/deepseek-r1-distill.pack.json` (template `deepseekr1`, seat `llama3`, train base `deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B`) and print merge, convert, seat, and import against fixture stubs. `make deepseek-r1-distill-lora-journey` and `make uniqueness-deepseek-lora` are the non-quant twin. Operator section 19. Print-only. This path does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| glm4 chat journey | The GLM-4 Chat prepare rows had no print-only prepare and seat journey. | PR #185 (`54c28b968879fccbc157dd7d9fdf7c10e9d0d58c`). `make glm4-chat-journey` and `make uniqueness-glm` check `llamafactory-qlora` on `examples/fixtures/glm4-chat.pack.json` (template `glm4`, seat `llama3`, train base `zai-org/glm-4-9b-chat`) and print merge, convert, seat, and import against fixture stubs. `make glm4-chat-lora-journey` and `make uniqueness-glm-lora` are the non-quant twin. Operator section 20. Print-only. This path does not invent a live PASS. Not in smoke, `make gate-90`, or Actions. READY no. |
| tip honesty through #181 | Tip framing stopped at PR #179 after the print-only purpose-build journey had landed. | PR #182 (`7e098a9b0ec360c952b2b1c2273654e44de6776c`). GATE-90 and Cell One name tip through PR #181 (`c4a6d255a08146613c9c6cba262959d913f5cac0`), including tip honesty through PR #179 (PR #180, `3fae4d53821966acfa69f688ba8de5405b20513e`) and print-only `make purpose-build-journey` (operator section 18). Docs and locks only. READY no. |
| tip honesty through #183 | Tip framing stopped at PR #181 after the print-only DeepSeek-R1-Distill journeys had landed. | PR #184 (`87482dbc847c364056df778fa6170a22efad4c8b`). GATE-90 and Cell One name tip through PR #183 (`b93e89f1983027a13008cc4be23f44756af0f22e`), including tip honesty through PR #181 (PR #182, `7e098a9b0ec360c952b2b1c2273654e44de6776c`) and print-only `make deepseek-r1-distill-journey`, `make uniqueness-deepseek`, `make deepseek-r1-distill-lora-journey`, and `make uniqueness-deepseek-lora` (operator section 19). Docs and locks only. READY no. |
| tip honesty through #185 | Tip framing stopped at PR #183 after the print-only GLM-4 Chat journeys had landed. | PR #186 (`ef839830b9de29caa963cece687e35c83dd77af6`). GATE-90 and Cell One name tip through PR #185 (`54c28b968879fccbc157dd7d9fdf7c10e9d0d58c`), including tip honesty through PR #183 (PR #184, `87482dbc847c364056df778fa6170a22efad4c8b`) and print-only `make glm4-chat-journey`, `make uniqueness-glm`, `make glm4-chat-lora-journey`, and `make uniqueness-glm-lora` (operator section 20). Docs and locks only. READY no. |
| checklist names DeepSeek and GLM | The purpose-build checklist named beachhead, qlora, lora, Axolotl, Unsloth, and the Apple Silicon print pointer, and left the DeepSeek-R1-Distill and GLM-4 Chat print journeys off step 1. | PR #187 (`4df2c56d5ab622ea3843ade97e4a0dec9ea5b01a`). `make purpose-build-checklist` step 1 names `make deepseek-r1-distill-journey`, `make uniqueness-deepseek`, the LoRA twins, `make glm4-chat-journey`, `make uniqueness-glm`, and the LoRA twins, and does not run them. Operator section 15. Print-only. READY no. |
| tip honesty through #187 | Tip framing stopped at PR #185 after the purpose-build checklist named the DeepSeek-R1-Distill and GLM-4 Chat print journeys. | GATE-90 and Cell One name tip through PR #187 (`4df2c56d5ab622ea3843ade97e4a0dec9ea5b01a`), including tip honesty through PR #185 (PR #186, `ef839830b9de29caa963cece687e35c83dd77af6`) and `make purpose-build-checklist` step 1 naming the DeepSeek-R1-Distill and GLM-4 Chat print journeys (operator section 15, PR #187). Docs and locks only. READY no. |
| operator surfaces name purpose-build | `docs/OPERATOR-DAY.md` and `docs/NORTH-STAR.md` did not name `make purpose-build-journey`, and GATE-90 Remaining for `make purpose-build-pick` omitted the DeepSeek-R1-Distill and GLM-4 Chat print targets the picker already prints. | `make purpose-build-journey` is the print-only purpose-build on-demand entry. It runs `make purpose-build-pick`, then `make purpose-build-checklist`. The pick Remaining row names DeepSeek-R1-Distill chat and GLM-4 Chat print targets and their uniqueness and LoRA twins. The picker does not run them. Tip stays through PR #187 (`4df2c56d5ab622ea3843ade97e4a0dec9ea5b01a`). Not in smoke, `make gate-90`, or Actions. READY no. |
...
make seat-journey     # opt-in: Target C seat ladder; refuse:tokenizer then fixture stubs; does not train or convert (not in smoke)
make train-next       # opt-in: print the NEXT.md train recipe after Target C prepare; does not train (not in smoke)
make uniqueness-ladder # opt-in: print-only Target C chain; qlora-journey then seat-journey; does not run train-next (not in smoke)
...
make purpose-build-checklist # opt-in: print-only purpose-build on demand; points at existing print journeys, including DeepSeek-R1-Distill and GLM-4 Chat, then Standing next (estate) (not in smoke)
make purpose-build-pick # opt-in: print-only host and stack picker; names existing journeys; does not run them (not in smoke)
make purpose-build-journey # opt-in: print-only purpose-build on-demand entry; runs purpose-build-pick then purpose-build-checklist (not in smoke)
make deepseek-r1-distill-journey # opt-in: DeepSeek-R1-Distill chat QLoRA ladder; template deepseekr1; does not train (not in smoke)
make uniqueness-deepseek # opt-in: print-only chain of that journey; prepare-assert then seat-print (not in smoke)
make deepseek-r1-distill-lora-journey # opt-in: DeepSeek-R1-Distill chat LoRA twin; does not train (not in smoke)
make uniqueness-deepseek-lora # opt-in: print-only chain of that LoRA journey; prepare-assert then seat-print (not in smoke)
make glm4-chat-journey # opt-in: GLM-4 Chat QLoRA ladder; template glm4; does not train (not in smoke)
make uniqueness-glm # opt-in: print-only chain of that journey; prepare-assert then seat-print (not in smoke)
make glm4-chat-lora-journey # opt-in: GLM-4 Chat LoRA twin; does not train (not in smoke)
make uniqueness-glm-lora # opt-in: print-only chain of that LoRA journey; prepare-assert then seat-print (not in smoke)
