...
Snapshot of **what is on `main` through PR #185** (`54c28b968879fccbc157dd7d9fdf7c10e9d0d58c`).
...
| tip honesty through #185 | Tip framing stopped at PR #183 after the print-only GLM-4 Chat journeys had landed. | GATE-90 and Cell One name tip through PR #185 (`54c28b968879fccbc157dd7d9fdf7c10e9d0d58c`), including tip honesty through PR #183 (PR #184, `87482dbc847c364056df778fa6170a22efad4c8b`) and print-only `make glm4-chat-journey`, `make uniqueness-glm`, `make glm4-chat-lora-journey`, and `make uniqueness-glm-lora` (operator section 20). Docs and locks only. READY no. |
| checklist names DeepSeek and GLM | The purpose-build checklist named beachhead, qlora, lora, Axolotl, Unsloth, and the Apple Silicon print pointer, and left the DeepSeek-R1-Distill and GLM-4 Chat print journeys off step 1. | `make purpose-build-checklist` step 1 names `make deepseek-r1-distill-journey`, `make uniqueness-deepseek`, the LoRA twins, `make glm4-chat-journey`, `make uniqueness-glm`, and the LoRA twins, and does not run them. Operator section 15. Print-only. The tip header stays through PR #185. READY no. |
