...
- `estate feed import --curator jason` copies a candidate to `accepted/` and does not rewrite the estate
- Wrong `--curator` refuses (`refuse:curator`). Locked curator is jason.
