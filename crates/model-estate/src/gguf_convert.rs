...
//! This module prints the command. It does not vendor the script, spawn it,
//! or write a GGUF.
//!
...
pub fn plan_gguf_convert(
    ...
    if doc.driver != LLAMAFACTORY_LORA_ID && doc.driver != LLAMAFACTORY_QLORA_ID {
        return Err(ModelError::Other(format!(
            "refuse:driver: gguf-convert reads a llamafactory-lora or llamafactory-qlora prepare, found '{}'",
            doc.driver
        )));
    }
