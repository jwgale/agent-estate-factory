...
/// `estate reconcile`, `estate leases`, and the `honesty.md` snapshot
...
/// end. Status, convey authority, reconcile, leases, and audit export
/// discard them and do not bail.
