...
printf '%-22s %-14s %s\n' "GLM-4 Chat" "print-only" "make glm4-chat-journey"
printf '%-22s %-14s %s\n' "GLM-4 Chat" "print-only" "make uniqueness-glm"
printf '%-22s %-14s %s\n' "GLM-4 Chat" "print-only" "make glm4-chat-lora-journey"
printf '%-22s %-14s %s\n' "GLM-4 Chat" "print-only" "make uniqueness-glm-lora"
echo
...
echo "GLM-4 Chat is print-only: make glm4-chat-journey and make uniqueness-glm, plus the LoRA twin make glm4-chat-lora-journey and make uniqueness-glm-lora. This picker does not run them."
