...
| `estate doctor --strict` and the dual-layer sacred demo (Sanctum is not Cyera). Doctor cites a placement hop capability that disagrees with hop coverage (`refuse:hop-coverage` mismatch) and does not write the mesh | Dual PE |
