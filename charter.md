...
- Swap the train/enrich driver (`ollama-modelfile`, `external-manifest`, `llamafactory-lora`, `llamafactory-qlora`, `axolotl-lora`, a later entrant) by registering a `TrainEnrichDriver` card. Floor core and control dispatch do not learn the trainer.
