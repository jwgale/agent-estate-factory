...
- Swap the train/enrich driver (`ollama-modelfile`, `external-manifest`, `llamafactory-qlora`, `llamafactory-lora`, `axolotl-lora`, a later entrant) by registering a `TrainEnrichDriver` card. Floor core and control dispatch do not learn the trainer.
